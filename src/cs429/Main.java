...
public class Main {
	...
	public static void doit(String name, int... prog) { //executes doits in main, taking in binary commands in a list 
		final byte[] memory = new byte[prog.length]; //byte array with each binary command
